...
public class DialogoPrestamo extends javax.swing.JDialog {
     ...
     */
    public DialogoPrestamo(VistaPrincipal parent, boolean modal, DefaultListModel modelo_lista) {
        super(parent, modal);
    ...
    private void boton_multipleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_boton_multipleActionPerformed
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "No ha sido posible crear el prestamo",
                    "Nuevo prestamo", JOptionPane.WARNING_MESSAGE);
        }
